...
- `vf-002`: FAIL
  ...
  - assertion: `vendor_fraud_score 35 < min 60`
  - assertion: `wire_transfer_anomaly_score 15 < min 35`
- `vf-003`: FAIL
  - assertion: `risk_score 48 < min 70`
  - assertion: `vendor_fraud_score 42 < min 65`
  - assertion: `wire_transfer_anomaly_score 15 < min 30`
...
- `vf-005`: FAIL
  ...
  - assertion: `wire_transfer_anomaly_score 0 < min 45`
...
- `ei-004`: PASS
- `ei-005`: FAIL
  - assertion: `risk_score 72 < min 80`
  - assertion: `vendor_fraud_score 25 < min 35`
  - assertion: `wire_transfer_anomaly_score 48 < min 55`
