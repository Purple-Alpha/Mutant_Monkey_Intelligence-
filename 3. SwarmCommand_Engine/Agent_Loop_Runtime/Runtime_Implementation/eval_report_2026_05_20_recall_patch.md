...
| Per-fraud-subcategory recall | >= 60% each | invoice_authenticity_anomaly 0.00%; lookalike_sender 0.00%; vendor_invoice_fraud 20.00% | NO |
...
- `vf-001`: PASS
- `vf-002`: FAIL
  - assertion: `risk_score 55 < min 65`
  - assertion: `vendor_fraud_score 55 < min 60`
- `vf-003`: FAIL
  - assertion: `risk_score 68 < min 70`
- `vf-004`: FAIL
  - assertion: `risk_score 12 < min 65`
  - assertion: `vendor_fraud_score 8 < min 60`
  - assertion: `wire_transfer_anomaly_score 5 < min 25`
  - assertion: `invoice_authenticity_score 82 > max 55`
  - assertion: `recommended_action 'safe' not in ['needs_review', 'block']`
- `vf-005`: FAIL
  - assertion: `risk_score 62 < min 75`
  - assertion: `vendor_fraud_score 48 < min 70`
  - assertion: `wire_transfer_anomaly_score 15 < min 45`
  - assertion: `invoice_authenticity_score 72 > max 50`
- `ei-001`: PASS
- `ei-002`: PASS
- `ei-003`: FAIL
  - assertion: `wire_transfer_anomaly_score 0 < min 25`
- `ei-004`: PASS
- `ei-005`: FAIL
  - assertion: `vendor_fraud_score 30 < min 35`
- `wt-001`: PASS
- `wt-002`: PASS
- `wt-003`: PASS
- `wt-004`: FAIL
  - assertion: `risk_score 38 < min 45`
- `ia-001`: FAIL
  - assertion: `risk_score 62 < min 75`
  - assertion: `vendor_fraud_score 55 < min 65`
  - assertion: `recommended_action 'needs_review' not in ['block']`
- `ia-002`: FAIL
  - assertion: `risk_score 48 < min 60`
  - assertion: `vendor_fraud_score 25 < min 45`
- `ia-003`: FAIL
  - assertion: `risk_score 62 < min 70`
- `ls-001`: FAIL
  - assertion: `risk_score 58 < min 70`
  - assertion: `vendor_fraud_score 52 < min 60`
- `ls-002`: FAIL
  - assertion: `risk_score 62 < min 75`
- `hi-001`: PASS
- `lv-001`: PASS
