...
| Per-fraud-subcategory recall | >= 60% each | executive_impersonation 40.00%; header_inconsistency 0.00%; invoice_authenticity_anomaly 0.00%; lookalike_sender 0.00%; vendor_invoice_fraud 20.00%; wire_transfer_pressure 50.00% | NO |
...
| wire_transfer_pressure | 4 | 2 | 50.00% |
