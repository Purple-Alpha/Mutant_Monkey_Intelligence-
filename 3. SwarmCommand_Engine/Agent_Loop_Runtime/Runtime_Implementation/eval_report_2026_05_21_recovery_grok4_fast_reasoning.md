...
| Per-fraud-subcategory recall | >= 60% each | invoice_authenticity_anomaly 33.33%; lookalike_sender 0.00%; vendor_invoice_fraud 40.00% | NO |
...
- `vf-003`: FAIL
  - assertion: `risk_score 62 < min 65`
- `vf-004`: PASS
- `vf-005`: FAIL
  - assertion: `risk_score 48 < min 75`
  - assertion: `vendor_fraud_score 38 < min 70`
  - assertion: `wire_transfer_anomaly_score 10 < min 45`
  - assertion: `invoice_authenticity_score 72 > max 50`
- `ei-001`: PASS
- `ei-002`: FAIL
  - assertion: `behavioral_deviation_flags missing required ['urgency_paired_with_finance']`
- `ei-003`: FAIL
  - assertion: `wire_transfer_anomaly_score 0 < min 10`
- `ei-004`: PASS
- `ei-005`: PASS
- `wt-001`: PASS
- `wt-002`: PASS
