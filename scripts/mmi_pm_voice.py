...
RECONCILE_YOU_DO = {
    ...
    "#65": "Authorize MMI_65_SCOREBOARD_SIGNED_UNBUILT_RECONCILE_ONLY.",
}
GATED_RECONCILE_YOU_DO = {
    ...
    "#65": "Authorize MMI_65_GATED_RECONCILE_ONLY.",
}
...
CONTRACT_DRAFT_GATE_GLOBS: dict[str, str] = {
    ...
    "#10": "mmi_10_contract_gate_*.md",
    "#18": "mmi_18_contract_gate_*.md",
    "#49": "mmi_49_contract_gate_*.md",
    "#50": "mmi_50_contract_gate_*.md",
}
