...
BACKUP_ALLOWLIST = [
    ...
    "scripts/install_m4_minifilter.ps1",
    "scripts/install_m4_wdk_toolset.ps1",
    ...
    "scripts/m4_authority_seal.py",
    "scripts/m4_boundary_daemon.py",
    "scripts/m4_fuzz_harness.py",
    "scripts/m4_minifilter_suite.py",
    "scripts/m4_sandbox_escape_suite.py",
    "scripts/m4_stage_attestation.py",
    "scripts/m4_wfp_suite.py",
    "host_boundary/mmi_boundary_daemon/",
    "host_boundary/mmi_minifilter/README.md",
    "host_boundary/mmi_minifilter/minifilter.c",
    "host_boundary/mmi_minifilter/mmi_minifilter.inf",
    "host_boundary/mmi_minifilter/mmi_minifilter.vcxproj",
    "host_boundary/mmi_minifilter/mmi_wdk_paths.props",
    "host_boundary/mmi_wfp/",
    ...
    "tests/test_m4_authority_seal.py",
    "tests/test_m4_boundary_daemon.py",
    "tests/test_m4_fuzz_harness.py",
    "tests/test_m4_minifilter_policy.py",
    "tests/test_m4_sandbox_escape_suite.py",
    "tests/test_m4_stage_attestation.py",
