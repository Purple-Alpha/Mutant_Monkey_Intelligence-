...
**Status:** CURRENT_PLAN populated 2026-06-21 (MMI-DEC-083). GSTF pivot feedstock superseded; regular ALL_CLEAR loop restored.
...
## CURRENT_PLAN — ALL_CLEAR feedstock v3

plan_status: CURRENT_PLAN
version_id: BOR-ALL-CLEAR-FEEDSTOCK-v3
population_authorization: MMI_BOR_ALL_CLEAR_FEEDSTOCK_v3
population_decision: MMI-DEC-083
created_at: 2026-06-21
source_contract: mmi/MMI_BLUEPRINT_OF_RECORD_GOVERNANCE_CONTRACT.md
architect_blueprint_source: scoreboard print + invariants Lane 1 probe closeout (MMI-DEC-082/083) + regular crew loop restore
revision_reason: Close #105 invariants probe slice; restore regular CONTRACT_DRAFT feedstock (#64 rank 1); keep #67 and #105 on hold
...
feedstock_entry: priority=1 candidate_id=#64 lane_type=CONTRACT_DRAFT name=Failure Classification
...
Completed GATED rows (#61 Test Case Generator, #62 Regression Test, #63 Adversarial Test) are omitted from feedstock; Estimator skips CLOSED lifecycle rows automatically.
