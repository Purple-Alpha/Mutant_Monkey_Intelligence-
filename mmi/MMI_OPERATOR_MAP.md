...
- **Governed agents:** 43 of 70 at production-quality Stage 1 (GOVERNED_AGENT)
...
1. **Promotion review #43 Geo-Context (GATED -> GOVERNED_AGENT when authorized)** — score 1/10
...
1. **#43 Geo-Context** — GATED, ready for promotion review
2. **#70 Final Review Agent** — GATED, ready for promotion review

## What to say to unstick (copy-paste)

```text
Authorize GOVERNED_AGENT promotion review #43 (Geo-Context)
```
