...
| Authority repo (`/mnt/c/Architectapp_clean`) | Read-only input. | Console never writes into the authority repo. All writes path-prefix-checked against `AUDIT_ROOT`. No promote/apply occurs in-process, ever. |
