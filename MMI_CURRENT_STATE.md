...
CURRENT_PROJECT_TRUTH: Mutant Monkey Security authority-repo control-plane queue: 0 SIGNED_UNBUILT, 0 AWAITING_AUDIT, 38 GATED rows; 4 untracked roadmap draft(s) in git status; legacy path /home/socialarchitect/northstar
TASK_SCOREBOARD: Classify parked roadmap drafts (4 files) [INTAKE_CLASSIFY_BATCH score=72]
...
SOURCE_EVIDENCE: git status untracked: MMI_Governance_Invariants_Testing_Advisory_Lane_Brief.md, MMI_Governance_Invariants_Testing_Framework_Contract.md, MMI_Governance_Stress_Testing_Advisory_Lane_Brief.md, MMI_Governance_Stress_Testing_Framework_Deep_Dive.md
...
CANDIDATES: [INTAKE] Classify parked roadmap drafts (4 files) | Classification: INTAKE_CLASSIFY_BATCH | Score: 72 | Source: git status untracked: MMI_Governance_Invariants_Testing_Advisory_Lane_Brief.md, MMI_Governance_Invariants_Testing_Framework_Contract.md, MMI_Governance_Stress_Testing_Advisory_Lane_Brief.md, MMI_Governance_Stress_Testing_Framework_Deep_Dive.md | Worker: Cursor | Matt action: NO
