MODE: AUDIT
AUTHORIZED_TASK: Run Grok completion gate for Load Fission Controller v2
...
RUN: python3 audit_tools/complete_gate.py --pre-commit --task load_fission_controller_v2 --claim "Load Fission Controller v2 build implemented + tested; ready for audit"
MANIFEST: audit_outputs/pending/load_fission_controller_v2.manifest.json (MISSING - create before gate)
