...
LAST_COMPLETED: MMI project-direction scoring — #47 Case Timeline contract-draft
  direction added to DIRECTION_SCOREBOARD (`MMI_PROJECT_DIRECTION_SCOREBOARD_INCLUDE_47`);
  eligible when #47 NEEDS_SIGNED_CONTRACT and #48 GOVERNED_AGENT; rubric total 15/20.
  Prior: #47 dependency re-triage (`80f128c`).
