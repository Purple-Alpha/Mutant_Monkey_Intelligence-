...
| 200 | Zero Unlock Buildable | `SIGNED_UNBUILT` | `4. Product_Roadmap/Fixture_Buildable_A_Agent_Design_Contract_Deep_Dive.md` | 2 Detection | A |  | BREADTH | — | adoption |
| 91 | Zero Unlock Row | `DETECTOR_FUNCTION` | `core/scoring/fixture_detector.py` | 2 Detection | A |  | BREADTH | — | adoption |
