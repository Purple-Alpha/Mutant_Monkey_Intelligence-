# Blue-Team Swarm — Estimator refresh fixture (one row richer code evidence)
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | Swarm Commander Agent | `DETECTOR_FUNCTION` (partial spine) | `core/orchestrator/routes.py`, `registry.py`, `swarm_commander.py`, `core/orchestrator/agent_contract.py` | 1 Command | A |  | BREADTH | — | adoption |
...
| 200 | Fixture Buildable A | `SIGNED_UNBUILT` | `4. Product_Roadmap/Fixture_Buildable_A_Agent_Design_Contract_Deep_Dive.md` | 2 Detection | A |  | BREADTH | 10 | abcdef0123456789abcdef0123456789abcdef |
