...
- Human_Written_Communication_Policy.md - operating rule (2026-05-23): every proposal / DM / email / letter to a human is written by Matt in his own words; AI proofreads only (typos, facts against repo, vague phrasings, tone) and never authors / structures / rewrites. Explicit allowed vs. forbidden AI actions, honest disclosure pattern, 5-step workflow, scope table by communication type, and ban on AI-drafted starting points. Cross-linked from `REVENUE_MAP.md` Operating Principle and "What Not To Do" #9.
