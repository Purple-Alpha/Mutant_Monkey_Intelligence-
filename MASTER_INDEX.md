...
- agent_concepts/Blue_Team_Swarm_70_Agent_Scoreboard.md - **v2 BUILD SEQUENCER (2026-06-08).** Canonical candidate generator for the Next-Action Rubric (D13-rev pending re-sign). Critical-path header + 70-row table with `BLOCKERS`, `TRACK`, `LAST_RUBRIC_SCORE`, `LAST_UPDATED`. Generator contract BS-D1–D6; authority-free (Rule 4). Queue retired as ordering authority.
