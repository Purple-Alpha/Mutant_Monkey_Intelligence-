...
- Runtime_Implementation/core/evidence_package/ - Cyber Insurance Evidence Package Pass 1 support surface: pure §7 gate library plus Markdown-first internal package generator. Produces deterministic structured records, manifest, gate logs, and Markdown bundle from existing §14 artifacts. Does not render PDF, call Grok, emit done declaration, alter runtime detection/scoring, or create buyer-facing release.
